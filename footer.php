...
<footer id="colophon" class="sticky bottom-0 py-4 z-100 site-footer bg-gradient-to-l from-sky-800 via-sky-700 to-sky-600 mobile:bg-gradient-to-l mobile:from-sky-800 mobile:via-sky-700 mobile:to-sky-600 mobile:rounded-full mobile:py-4 mobile:px-12" role="contentinfo">
	...
	<div class="container flex items-center justify-between mx-auto text-right gap-x-4 mobile:justify-center">
		<div class="">
			...
			// 		'container_class' => 'footer-nav',
			// 		'container_id' => 'fm-1-id',
			// 		'menu_class' => 'flex gap-x-4 items-center justify-center',
			// 		'menu_id' => '',
			// 		'depth' => 1,
			// 	));
			// }?>
		...
		<div class="flex items-center justify-center mr-4 gap-x-4">
			<?php if($facebook) : ?>
				<a href="<?php echo $facebook;?>" target="_blank" class="transition-all duration-150 ease-in-out text-white/90 hover:text-white">
					<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 50 50" class="size-6">
			...
			<?php if($instagram) : ?>
				<a href="<?php echo $instagram;?>" target="_blank" class="transition-all duration-150 ease-in-out text-white/90 hover:text-white">
					<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 64 64" class="size-6">
		...
		<div class="flex items-center text-white gap-x-1">
			...
			<a href="https://teachforromania.org" target="_blank" class="font-bold hover:text-slate-800"><?php echo $copyrights;?></a> &copy; <?php echo date_i18n( 'Y' );?>
		</div>
	</div>
	<?php do_action( 'tailpress_footer' ); ?>
</footer>
